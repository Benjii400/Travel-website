...
<body>
   ...
   <section class="about">
      ...
      <div class="content">
         <h3>why choose us?</h3>
         <p>Ethiopia has a lot of adventure and places to tour! and travel.et provides a lot of destinations with affordable prices.</p>
         <p>travle.et is a free platform which means that you dont have to pay any thing to use this web site and also no registratio or login is required to use it.</p>
